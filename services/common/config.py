...
config = {
    ...
    "nginxPublicBaseUrl": _env("ATLASWORKS_NGINX_PUBLIC_BASE_URL", default=""),
    "nginxPublicBasePort": _as_int(_env("ATLASWORKS_NGINX_PUBLIC_BASE_PORT"), 18080),
    "geoserverBaseUrl": _env("ATLASWORKS_GEOSERVER_BASE_URL", default="http://atlasworks-geoserver:8080/geoserver"),
    "geoserverPublicBaseUrl": _env("ATLASWORKS_GEOSERVER_PUBLIC_BASE_URL", default=""),
    "geoserverPublicBasePort": _as_int(_env("ATLASWORKS_GEOSERVER_PUBLIC_BASE_PORT"), 18083),
    "geoserverUsername": _env("ATLASWORKS_GEOSERVER_USERNAME", default="admin"),
    "geoserverPassword": _env("ATLASWORKS_GEOSERVER_PASSWORD", default="geoserver"),
    "geoserverWorkspace": _env("ATLASWORKS_GEOSERVER_WORKSPACE", default="atlasworks"),
    "geoserverDataSourceDir": _env("ATLASWORKS_GEOSERVER_DATA_SOURCE_DIR", default="/opt/geoserver/data_dir/dataSource"),
