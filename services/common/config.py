...
config = {
    ...
    "titilerPublicBaseUrl": _env("ATLASWORKS_TITILER_PUBLIC_BASE_URL", default=""),
    "titilerPublicBasePort": _as_int(_env("ATLASWORKS_TITILER_PUBLIC_BASE_PORT"), 18002),
    "titilerTileMatrixSet": _env("ATLASWORKS_TITILER_TILE_MATRIX_SET", default="WebMercatorQuad"),
